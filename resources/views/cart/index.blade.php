                    ...
                    <tbody ng-repeat="item in carts track by $index">
                      <tr class="cart-product-{{ item.productId }}">
                        ...
                        <td class="text-center">
                          <img class="img-product" ng-src="{{partImgProductOrder}}/{{item.btfCode}}.jpg" err-SRC="{{partImgProduct}}/Noimage.jpg"> {{item.productCode}}</td>
                      ...
                      <tr class="cart-product-{{ item.productId }}" ng-repeat="bom in boms track by $index" ng-if="bom.productRefCode == item.productCode">
                        <td class="text-center">{{$index+1}}</td>
                        <td class="text-center">
                          <img class="img-product" ng-src="{{partImgProductOrder}}/{{bom.btfCode}}.jpg" err-SRC="{{partImgProduct}}/Noimage.jpg"> {{bom.productCode}}</td>
                      ...
                      <div class="form-group col-md-6" ng-if="customer.isReceive ===true">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <label class="checkbox-inline">
                            <input type="checkbox" ng-click="pickUp(shipCondition)" ng-model="shipCondition" name="shipCondition"
                              value="01"> มารับเอง</label>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <label class="radio-inline">
                            <input type="radio" name="optradio" ng-model="paymentTerm" ng-change="changePay( ( customer.paymentTerm == 'CA02' || customer.paymentTerm =='CASH') ? customer.paymentTerm : 'CASH')"
                              value="{{ ( customer.paymentTerm == 'CA02' || customer.paymentTerm =='CASH') ? customer.paymentTerm : 'CASH'}}">เงินสด</label>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <!--<span ng-show="formcart.date_id.$error.required"><font color="red" size="2px">Required Field</font></span>-->
                        </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group col-md-6" ng-if="(ddlShipTo.shipCondition == '03'  || customer.shipCondition == '03') && shippingType=='show'">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          ...
                          <!--
                          <select ng-if="transports.length == 0 && ( ddlShipTo.shipCondition == '03' || customer.shipCondition == '03' )" name="trans_id"
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <!-- <span ng-show="formcart.trans_id.$error.required"><font color="red" size="2px">Required Field</font></span> -->
                        </div>
                      </div>
                    </div>
                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group col-md-6" ng-if="(ddlShipTo.shipCondition == '03') && shippingType=='show'">
                        ...
                        <label class="col-md-9 col-sm-9 col-xs-12">{{ddlShipTo.shipCondition == '08' ? ddlShipTo.transportZone + ' ' + ddlShipTo.transportZoneDesc :
                          ddlTransport.transportZone}} {{ddlTransport.transportZoneDesc}}</label>
                      </div>
                    </div>
                  </form>
                </div>
