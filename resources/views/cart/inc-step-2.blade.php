      ...
      <form class="form-horizontal form-label-left" name="formcart">
          ...
          <div class="form-group col-md-6" ng-if="customer.isReceive ===true">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <label class="checkbox-inline">
                <input type="checkbox" ng-click="pickUp(shipCondition)" ng-model="shipCondition" name="shipCondition" value="01"> มารับเอง</label>
            </div>
          </div>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
          ...
          <div class="form-group col-md-6" ng-if="(ddlShipTo.shipCondition == '03'  || customer.shipCondition == '03') && shippingType=='show'">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
              <select ng-if="( ddlShipTo.shipCondition == '03' || customer.shipCondition == '03' ) && transports.length > 0" name="trans_id"
