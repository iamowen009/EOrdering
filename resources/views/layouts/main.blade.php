      ...
      <div class="modal-body" id="modal-body" style="padding:none;">
        ...
        <div class="col-sm-12" ng-repeat="item in items" style="margin-left:-10px;">
          <label class="text-left col-sm-1">
            <a style="cursor: pointer;" ng-click="removeCart(item)">
              <i class="fa fa-trash"></i>
            </a>
          </label>
          <label class="col-sm-11 text-left">{{item.productCode}}</label>
          <span class="blue-underline" ng-if="item.promotionId != 0">(ของแถม)</span>
          <label class="text-left col-sm-1"></label>
          <label class="col-md-11" style="font-size: 15px;">{{item.productNameTh}}</label>
          <span class="text-danger" ng-if="item.isFreeGoodes === true">(ของแถม)</span>
          <div class="col-md-4 text-right">
            <img ng-src="{{partImgProductCard}}/{{item.btfCode}}.jpg" style="width:60%;" err-SRC="{{partImgProduct}}/Noimage.jpg">
          </div>
          <div class="col-md-8">
            ...
            <div class="form-group">
              ...
              <div class="col-md-3">
                <div class="input-group">
                  ...
                  <p class="text-center" ng-show="loadingcart">
                    <span class="fa fa-refresh  fa-spin"></span>
                  </p>
                </div>
              </div>
              <div class="col-md-12">
                <!--strong>หน่วย : </strong-->{{item.unitNameTh}}
                <span ng-if="item.altUnitAmount > 0">(1 {{ item.altUnitNameTh }} : {{item.altUnitAmount }} {{ item.unitNameTh }})</span>
                <p class="text-center" ng-show="loadingcart">
                  <span class="fa fa-refresh  fa-spin"></span>
                </p>
              </div>
          ...
          <div class="col-sm-12" ng-repeat="bom in bomxs" ng-if="bom.productRefCode == item.productCode" style="margin-left:10px; margin-top:20px;">
            ...
            <div class="col-md-4 text-right">
              <img ng-src="{{partImgProductCard}}/{{bom.btfCode}}.jpg" style="width:60%;" err-SRC="{{partImgProduct}}/Noimage.jpg">
            </div>
            <div class="col-md-8">
              <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <!--strong>หน่วย : </strong-->{{bom.unitNameTh}}
                  <span ng-if="bom.altUnitAmount > 0">(1 {{ bom.altUnitNameTh }} : {{bom.altUnitAmount }} {{ bom.unitNameTh }})</span>
