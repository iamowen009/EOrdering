				...
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					...
					<div class="panel-content panel panel-default">
                      ...
                      <div class="panel-body">
		                     ...
		                     <div class="form-group">
		                      ...
		                      <div class="form-group" ng-show="marketingmodel.length>0">
		                        ...
		                        <div class="col-md-9 col-sm-9 col-xs-12">
		                        	...
		                        	<span style="margin-right:5px;" class="label label-info" ng-repeat="m in marketings" ng-show="getResult(m.id).length>0">{{m.marketingDesc}}</span>
						...
						<!--<br>
						<h6><span class="fa fa-arrow-down"></span> สีทาอาคาร</h6>
