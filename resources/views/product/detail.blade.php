              ...
              <form action="/cart/add" name="add_to_cart" method="post" class="form-horizontal form-label-left" accept-charset="UTF-8">
                ...
                <div class="form-group" ng-show="productSelect.productId">
                  ...
                  <div class="pdprice col-md-9 col-sm-9 col-xs-12">
                    <font color="red">
                      <strong>{{productPrice | number:2 }}</strong>
                    </font>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="input-group">
                      <span class="input-group-btn">
                        <button type="button" class="btn btn-default" ng-click="removeQty()">
                          <i class="fa fa-minus"></i>
                        </button>
                      </span>
                      <input class="form-control text-center" type="text" numbers-only ng-model="cartProductQty">
                      <span class="input-group-btn">
                        <button type="button" class="btn btn-default" ng-click="addQty()">
                  ...
                  <div class="col-md-4">
                    <div style="margin-top:10px; " ng-show="productSelect.productId">
                      ...
                      <span ng-if="productSelect.altUnit1Amount > 0">( 1 {{ productSelect.altUnit1NameTh }} : {{productSelect.altUnit1Amount }} {{ productSelect.unitNameTh
                        }})
                      </span>
                    </div>
                  </div>
                ...
                <div class="form-group" ng-show="productSelect.productId">
                  ...
                  <div class="pdprice col-md-9 col-sm-9 col-xs-12">
                    <font color="#00BFFF">
                      <strong>{{+productPrice * +cartProductQty | number:2}}</strong>
                    </font>
                  </div>
                </div>
                <div>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12" dir-paginate="product in products | itemsPerPage: 6" pagination-id="product.id">
                      <div class="cui-ecommerce--catalog--item">
                        ...
                        <div class="cui-ecommerce--catalog--item--img-thumb">
                          ...
                          <a href="javascript: void(0);">
                            <img ng-src="{{partImgProductList}}/{{product.btf}}.jpg" err-SRC="{{partImgProduct}}/Noimage.jpg" ng-click="toProductDetail(product.btf)"
                              class="img-responsive img-product product-list">
                          </a>
                        </div>
